...
def main():
    ...
    with st.sidebar:
        ...
        # Add "Application History" to the navigation options
...
# Save the uploaded file
    ...
    # Only display form fields on "Upload Resume" page
    if page == "Upload Resume":
        ...
        if st.session_state.get("show_login_form") or page == "LinkedIn Login":
            ...
            if st.button("Submit and Login"):
                ...
                if driver:
                    ...
                    st.success("Logged in successfully! You can now proceed to the Auto Apply section.")

                    # Add a "Continue to Auto Apply" button
